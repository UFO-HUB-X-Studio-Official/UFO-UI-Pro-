...
do
    ...
    -- ====== สร้างปุ่มที่ขอ: player + รูป ======
CreateLeftButton("plaayer", 116976545042904)
-- แสดงชื่อ/รูปทันทีเหมือนกดแล้ว
do
    ABIcon.Image = "rbxassetid://116976545042904"
    ABText.Text  = "player"
...
do
    ...
    -- ====== สร้างปุ่มที่ขอ: player + รูป ======
CreateLeftButton("plajkyer", 116976545042904)
-- แสดงชื่อ/รูปทันทีเหมือนกดแล้ว
do
    ABIcon.Image = "rbxassetid://116976545042904"
    ABText.Text  = "player"
...
-- ====== สร้างปุ่มที่ขอ: player + รูป ======
CreateLeftButton("playaker", 116976545042904)
-- แสดงชื่อ/รูปทันทีเหมือนกดแล้ว
do
    ABIcon.Image = "rbxassetid://116976545042904"
    ABText.Text  = "player"
...
-- ====== สร้างปุ่มที่ขอ: player + รูป ======
CreateLeftButton("playajaer", 116976545042904)
-- แสดงชื่อ/รูปทันทีเหมือนกดแล้ว
do
    ABIcon.Image = "rbxassetid://116976545042904"
    ABText.Text  = "player"
...
-- ====== สร้างปุ่มที่ขอ: player + รูป ======
CreateLeftButton("playekjr", 116976545042904)
-- แสดงชื่อ/รูปทันทีเหมือนกดแล้ว
do
    ABIcon.Image = "rbxassetid://116976545042904"
    ABText.Text  = "player"
...
-- ====== สร้างปุ่มที่ขอ: player + รูป ======
CreateLeftButton("playaaer", 116976545042904)
-- แสดงชื่อ/รูปทันทีเหมือนกดแล้ว
do
    ABIcon.Image = "rbxassetid://116976545042904"
    ABText.Text  = "player"
...
-- ====== สร้างปุ่มที่ขอ: player + รูป ======
CreateLeftButton("plasjwjyer", 116976545042904)
-- แสดงชื่อ/รูปทันทีเหมือนกดแล้ว
do
    ABIcon.Image = "rbxassetid://116976545042904"
    ABText.Text  = "player"
...
-- ====== สร้างปุ่มที่ขอ: player + รูป ======
CreateLeftButton("plaskskyer", 116976545042904)
-- แสดงชื่อ/รูปทันทีเหมือนกดแล้ว
do
    ABIcon.Image = "rbxassetid://116976545042904"
    ABText.Text  = "player"
